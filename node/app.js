...
var watchApi = 'http://localhost:3000/api/listwatch'
var employeeApi = 'http://localhost:3000/api/listemployee'
var customerApi = 'http://localhost:3000/api/listcustomer'
var branchApi = 'http://localhost:3000/api/listbranch'
var billApi = 'http://localhost:3000/api/listbill'
function start() {
...
function addEmployees(data,callback){
  var options = {
    meothd:"POST",
...
function handleCreateForm(){
  var createBtn = document.querySelector('#addEmployee');
